...
[![Crates.io](https://img.shields.io/crates/v/toondb-grpc.svg)](https://crates.io/crates/toondb-grpc)
[![Documentation](https://docs.rs/toondb-grpc/badge.svg)](https://docs.rs/toondb-grpc)
[![License](https://img.shields.io/badge/license-Apache--2.0-blue.svg)](LICENSE)

**ToonDB gRPC Server** - Production-ready gRPC services for cross-language database access. Implements the Thick Server / Thin Client architecture where business logic resides in the server, and clients connect via gRPC or IPC.
...
# Unix domain socket
toondb-grpc-server --socket /tmp/toondb.sock
```

### Environment Variables

```bash
TOONDB_LOG=debug       # Enable debug logging
TOONDB_PORT=50051      # Server port
TOONDB_HOST=0.0.0.0    # Bind address
```
...
```rust
use toondb_grpc::graph_server::GraphService;
...
Proto definitions available at: [proto/toondb.proto](https://github.com/toondb/toondb/blob/main/proto/toondb.proto)

Generate clients:

```bash
# Python
python -m grpc_tools.protoc -I./proto --python_out=. --grpc_python_out=. proto/toondb.proto

# Node.js
npm install @grpc/grpc-js @grpc/proto-loader
grpc_tools_node_protoc --js_out=import_style=commonjs,binary:. --grpc_out=grpc_js:. proto/toondb.proto

# Go
protoc --go_out=. --go-grpc_out=. proto/toondb.proto
```
...
See [CONTRIBUTING.md](https://github.com/toondb/toondb/blob/main/CONTRIBUTING.md)
...
- **SDKs**:
  - [Python SDK](https://pypi.org/project/toondb/)
  - [Node.js SDK](https://www.npmjs.com/package/toondb)
