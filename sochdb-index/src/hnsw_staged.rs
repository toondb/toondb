...
mod tests {
    ...
    fn test_staged_self_retrieval() {
        ...
        // Note: Staged insertion may have lower self-retrieval rates than normal insertion
        // due to deferred neighbor updates. This is acceptable for bulk loading scenarios.
        assert!(success_rate >= 60.0, "Self-retrieval rate too low: {}%", success_rate);
    }
}
