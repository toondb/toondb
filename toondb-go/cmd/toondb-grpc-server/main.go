...
func findBinary(name string) (string, error) {
	if envPath := os.Getenv("TOONDB_GRPC_SERVER_PATH"); envPath != "" {
...
func main() {
	...
	if err != nil {
		...
		fmt.Fprintln(os.Stderr, "Please ensure ToonDB is installed or set TOONDB_GRPC_SERVER_PATH.")
		os.Exit(1)
	}
